...
//Bbraun::Bbraun(std::string config_file):Device{config_file}
//{
...
//    write_to_serial_port(payload_data, temptxbuff.size());
...
//    qDebug()<<"sending ACK";
//    write_to_serial_port(payload_data, temptxbuff.size());
//    //this->local_serial_port->serial->write();
//}
