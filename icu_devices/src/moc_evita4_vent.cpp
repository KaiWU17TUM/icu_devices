...
#define QT_MOC_LITERAL(idx, ofs, len)                            \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
                                                            qptrdiff(offsetof(qt_meta_stringdata_Evita4_vent_t, stringdata0) + ofs - idx * sizeof(QByteArrayData)))
...
void Evita4_vent::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod)
    {
        ...
        case 2:
            ...
            break;
        case 3:
            _t->request_measurement_cp1();
            break;
        case 4:
            _t->request_measurement_cp2();
            break;
        case 5:
            _t->request_device_settings();
            break;
        case 6:
            _t->request_text_messages();
            break;
        case 7:
            _t->request_stop_communication();
            break;
        default:;
        }
    }
